...
class BayarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val txtTotalTransaksi = view.findViewById<TextView>(R.id.txtTotalTransaksiBayar)
...
//                        txtKembalian.setText(numberFormat.format(kembalian.toDouble().toString()))
    ...
    fun simpanPembayaran(view: View) {
        ...
        btnSimpan.setOnClickListener {
            api.postTransaksi(token.toString(),admin_id.toString().toInt(),total.toString().toInt()).enqueue(object :
                ...
                override fun onResponse(
                    ...
                    for (items in myCart!!){
                        api.postItemTransaksi(token.toString(),id_transaksi.toString().toInt(),items.id, items.qty, items.harga).enqueue(object :
                    ...
                    Toast.makeText(view.context, "Transaksi Berhasil Disimpan", Toast.LENGTH_SHORT).show()
